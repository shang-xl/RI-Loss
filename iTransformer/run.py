...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_len', type=int, default=18, help='start token length') # no longer needed in inverted Transformers
    ...
    parser.add_argument('--loss', type=str, default='MSE', help='loss function options: [mse, RI-Loss]')
